...
Toggles enabling support for builtin/feature proposals that have shipped in browsers. If your target environments have native support for a feature proposal, its matching parser syntax plugin is enabled instead of performing any transform. Note, this is _not_ the same as enabling [`babel-preset-stage3`](https://babeljs.io/docs/plugins/preset-stage-3/), as proposals may change before landing in browsers.
