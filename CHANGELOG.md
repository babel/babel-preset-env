...
- Fix typo ([#78](https://github.com/babel/babel-preset-env/pull/78)) [skip ci] (@rohmanhm)
- Fix PR link in changelog. ([#75](https://github.com/babel/babel-preset-env/pull/75)) [skip ci] (@nhajidin)
