...
testRunner(fixturesDir, "babel-preset-env", {}, {}, (fixtureOptions, test) => {
  const presetOptions = fixtureOptions.presets && fixtureOptions.presets[0][1];

  if (presetOptions && presetOptions.targets && presetOptions.targets.browserslistConfigPath) {
